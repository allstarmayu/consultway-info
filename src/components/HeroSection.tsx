    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-cream">
      ...
      <div className="relative z-10 container mx-auto px-6 lg:px-8 text-center max-w-4xl">
        ...
        >
          ...
          <a
            href="#services"
            className="inline-flex items-center justify-center px-7 py-3.5 rounded-lg border border-border text-foreground font-medium text-base hover:bg-secondary active:scale-[0.97] transition-all duration-200"
          >
            Explore Services
          </a>
        </motion.div>
