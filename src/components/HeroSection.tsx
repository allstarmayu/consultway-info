...
const HeroSection = () => {
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center bg-navy overflow-hidden">
      {/* Animated grid */}
      <div className="absolute inset-0 grid-pattern animate-grid-drift opacity-40" />
      
      {/* Radial fade */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,transparent_0%,hsl(var(--navy))_70%)]" />
      ...
      <div className="relative z-10 container mx-auto px-6 lg:px-8 text-center max-w-4xl">
        ...
        <motion.h1
          className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-primary-foreground leading-[1.05] mb-6"
        ...
        >
          ...
          <a
            href="#services"
            className="inline-flex items-center justify-center px-7 py-3.5 rounded-lg border border-primary-foreground/20 text-primary-foreground/80 font-medium text-base hover:bg-primary-foreground/5 active:scale-[0.97] transition-all duration-200"
          >
            Explore Services
          </a>
        </motion.div>
      ...
      <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-[hsl(var(--navy-light))] to-transparent" />
    </section>
  );
};
