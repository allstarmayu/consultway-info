...
const HeroSection = () => {
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center bg-background overflow-hidden">
      {/* Animated grid */}
      <div className="absolute inset-0 grid-pattern animate-grid-drift opacity-60" />
      ...
      <div className="relative z-10 container mx-auto px-6 lg:px-8 text-center max-w-4xl">
        ...
        >
          ...
          <a
            href="#services"
            className="inline-flex items-center justify-center px-7 py-3.5 rounded-lg border border-border text-foreground/80 font-medium text-base hover:bg-secondary active:scale-[0.97] transition-all duration-200"
          >
            Explore Services
          </a>
        </motion.div>
